...
import controller.upload.UmlUploadProcessor2.Uml2SequenceDiagramUploadProcessor.XmiElementLifeLine;
 ...
 * 
 */
public class UmlUploadProcessor2 implements UploadProcessor {
	...
	public UmlUploadProcessor2(List<FileInfo> list, String path, int id) {
		fileList = list;
	 ...
	 * 
	 */
	private class Uml2ClassUploadProcessor extends CreatePngFile {
	...
	private class Uml2SequenceDiagramUploadProcessor extends CreatePngFile{
		public void process() {

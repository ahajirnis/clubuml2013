...
public class Compare extends HttpServlet {
	...
	CompareDiagrams compareObj = new CompareDiagrams(context.getRealPath(diagram1.getEcoreFilePath()), context.getRealPath(diagram2.getEcoreFilePath()), context.getRealPath("/reports/"));
	try {
	    ...
	    RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/JSP/promote.jsp");
